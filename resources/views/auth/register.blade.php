            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row" style="direction: rtl;text-align: right">
                            <label for="password" class="col-md-2 col-form-label text-md-right">{{ __('کلمه عبور') }}</label>
                        ...
                        <div class="form-group row" style="direction: rtl;text-align: right">
                            <label for="password-confirm" class="col-md-2 col-form-label text-md-right">{{ __('تکرار کلمه عبور') }}</label>
